...
import { useAdminStatsWindowStore } from './stats-window-store';
...
export default function AdminStats() {
  ...
  const windowState = useAdminStatsWindowStore((s) => s.state);
  const setWindowState = useAdminStatsWindowStore((s) => s.setState);
  const [range, setRange] = useState<StatsDateRange>(() =>
    deriveRange(windowState),
  );
