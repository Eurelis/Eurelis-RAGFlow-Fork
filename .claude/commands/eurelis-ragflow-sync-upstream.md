...
# /eurelis-ragflow-sync-upstream — Synchronisation fork Eurelis ↔ upstream RAGFlow
...
Créer le fichier `docs/eurelis/eurelis-ragflow-sync-upstream/YYYY-MM-DD.md` (remplacer la date réelle) avec le contenu suivant, en remplaçant toutes les variables par leurs valeurs réelles :
