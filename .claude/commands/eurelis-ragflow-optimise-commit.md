...
# /eurelis-ragflow-optimise-commit — Commit optimisé pour eurelis/main
...
Exemples :
- `/eurelis-ragflow-optimise-commit fix timeout in retrieval pipeline`
- `/eurelis-ragflow-optimise-commit feat add hybrid search support`
- `/eurelis-ragflow-optimise-commit docs update release guidelines`
...
2. **Message** : `$ARGUMENTS` ne doit pas être vide. Sinon, **arrêter** :
   > ERREUR : Un message de commit est requis. Usage : /eurelis-ragflow-optimise-commit \<message\>
