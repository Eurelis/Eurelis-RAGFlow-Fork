...
async def async_ask(question, kb_ids, owner_tenant_id, acting_user_id=None, chat_llm_name=None, search_config={}, search_id=None):
    ...
    chat_model_config = get_model_config_from_provider_instance(owner_tenant_id, LLMType.CHAT, chat_llm_name)
    chat_mdl = LLMBundle(owner_tenant_id, chat_model_config)
    if rerank_id:
        rerank_model_config = get_model_config_from_provider_instance(owner_tenant_id, LLMType.RERANK, rerank_id)
